...
const Index = () => {
  const { machines, liveReadings } = useLiveSensorData(3000);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-[1600px] space-y-6 px-6 py-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <SensorTrendChart liveReadings={liveReadings} />
          <ComparisonChart machines={machines} />
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <HealthStatus machines={machines} />
          <MaintenanceSchedule machines={machines} />
        </div>
      </main>
    </div>
  );
